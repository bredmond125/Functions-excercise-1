...
console.log(`circle area is ${getAreaOfCircle()}, circle circumference is ${getCircumferenceOfCircle()}, square area is ${getAreaOfSquare()}, triangle area is ${getAreaOfTriangle()}`)